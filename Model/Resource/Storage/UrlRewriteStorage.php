...
class UrlRewriteStorage
{
    ...
    protected function writeUrlRewrites(array $urlRewrites, ValueSerializer $valueSerializer, $buildIndex)
    {
        ...
        $this->db->insertMultipleWithIgnore($this->metaData->urlRewriteTable,
            ['entity_type', 'entity_id', 'request_path', 'target_path', 'redirect_type', 'store_id', 'is_autogenerated', 'metadata'], $newRewriteValues);
